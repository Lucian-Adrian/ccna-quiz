# CCNA 1 v7 ITN v7.02 Practice Final Exam Answers 2026 100%

Source: [https://infraexam.com/ccna1-v7/ccna1-v7-itnv7-practice-final-itn-answers/](https://infraexam.com/ccna1-v7/ccna1-v7-itnv7-practice-final-itn-answers/)
...
- [x] **An SVI is created in software and requires a configured IP address and a subnet mask in order to provide remote access to the switch.**
...
![exhibit](https://infraexam.com/wp-content/uploads/2026/03/CCNA1-Introduction-to-Networks-Practice-Final-Exam-Answers-001.png)

![exhibit](https://infraexam.com/wp-content/uploads/2026/03/CCNA1-Introduction-to-Networks-Practice-Final-Exam-Answers-001-1024x418.png)
...
![exhibit](https://infraexam.com/wp-content/uploads/2020/04/CCNA1-v7-ITNv7-Practice-Final-ITN-Answers-003.png)
...
![exhibit](https://infraexam.com/wp-content/uploads/2020/04/CCNA1-v7-ITNv7-Practice-Final-ITN-Answers-002-1.jpg)
...
- [x] **Fiber-optic cabling does not conduct electricity.**
- [ ] Fiber-optic cabling has high signal loss.
- [x] **Fiber-optic cabling is primarily used as backbone cabling.**
...
![exhibit](https://infraexam.com/wp-content/uploads/2026/03/CCNA1-Introduction-to-Networks-Practice-Final-Exam-Answers-002.png)

![exhibit](https://infraexam.com/wp-content/uploads/2026/03/CCNA1-Introduction-to-Networks-Practice-Final-Exam-Answers-002-1024x497.png)
...
- [ ] the use of CSMA/CA
- [x] **the use of full-duplex capable Layer 2 switches**
...
- [x] **a malfunctioning NIC**
- [ ] CRC errors
- [ ] electrical interference on serial interfaces
- [x] **half-duplex operations**
...
- [x] **The host can communicate with other hosts on the local network, but is unable to communicate with hosts on remote networks.**
...
![exhibit](https://infraexam.com/wp-content/uploads/2020/04/CCNA1-v7-ITNv7-Practice-Final-ITN-Answers-004-1.jpg)

- [ ] RT1 will forward the ARP request to PC3.
- [x] **RT1 will send an ARP reply with its own Fa0/0 MAC address.**
...
![exhibit](https://infraexam.com/wp-content/uploads/2020/04/CCNA1-v7-ITNv7-Practice-Final-ITN-Answers-006.png)
...
![exhibit](https://infraexam.com/wp-content/uploads/2026/03/CCNA1-Introduction-to-Networks-Practice-Final-Exam-Answers-003.png)

![exhibit](https://infraexam.com/wp-content/uploads/2026/03/CCNA1-Introduction-to-Networks-Practice-Final-Exam-Answers-003-1024x492.png)
...
![exhibit](https://infraexam.com/wp-content/uploads/2026/03/CCNA1-Introduction-to-Networks-Practice-Final-Exam-Answers-004.png)

![exhibit](https://infraexam.com/wp-content/uploads/2026/03/CCNA1-Introduction-to-Networks-Practice-Final-Exam-Answers-004-1024x622.png)
...
![exhibit](https://infraexam.com/wp-content/uploads/2020/04/CCNA1-v7-ITNv7-Practice-Final-ITN-Answers-005.png)

- [ ] ::1/128
- [x] **fe80::30d0:115:3f57:fe4c/128**
- [ ] fe80::/64
...
- [x] **verifying that there is connectivity to the internet**
...
- [x] **testing the integrity of the TCP/IP stack on the local machine**
...
![exhibit](https://infraexam.com/wp-content/uploads/2020/04/CCNA1-v7-ITNv7-Practice-Final-ITN-Answers-001.jpg.webp)

- [ ] the amount of data that can be sent at one time
- [ ] the total number of bits received during this TCP session
- [x] **the amount of data that can be sent before an acknowledgment is required**
...
- [x] **A packet-filtering firewall typically can filter up to the transport layer, whereas a stateful firewall can filter up to the session layer.**
...
- [x] **Add a connection to the Internet via a DSL line to another ISP.**
